...
if (1){
  ...
  #tw_rel <- tw01[is.element(tw01$Werbeflaeche,rel_adspace_name) & is.element(tw01$Werbemittel,rel_ads_name),]
  
  tw_rel = rel_october_red
  ...
  # Filter these out -> already done by AdSpaceSummary.R
